...
Gpio.prototype.setMode = function (_gpio, _mode) {
 ...
 * @param {Number} _gpio 
 */
Gpio.prototype.export = async function(_gpio) {
    const gpio = _gpio ?? this._gpio;
...
Gpio.prototype.exported = function(_gpio) {
    const gpio = _gpio ?? this._gpio;
...
Gpio.prototype.sleep = function(_gpio, time) {
    const gpio = _gpio ?? this._gpio;
